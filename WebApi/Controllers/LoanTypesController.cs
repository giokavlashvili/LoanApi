...
namespace WebApi.Controllers
{
    ...
    public class LoanTypesController : ApiControllerBase
    {
        ...
        public async Task<ActionResult<List<LoanTypeDto>>> GetAll() => await Mediator.Send(new GetLoanTypesQuery());
    }
}
